...
from courses.views import (CourseSubscriptionApiView, CourseViewSet, LessonCreateAPIView, LessonDestroyAPIView,
...
urlpatterns = [
    path("courses/<int:pk>/subscribe", CourseSubscriptionApiView.as_view(), name="course_subscription"),
